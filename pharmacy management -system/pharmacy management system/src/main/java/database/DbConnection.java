...
public class DbConnection {
    ...
    public DbConnection() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/pharmacy?characterEncoding=utf8&useSSL=false&autoReconnect=true", username,password);
            if (con != null) {
                System.out.println("Connected to Pharmacy Database");
            }else{
